...
$(document).ready(function() {
	$("#btnSearch").click(function() {
		...
		if($("#select").val() == "title"){
		document.form1.action="${path}/freeboard/freeboard_search_title.do";
		document.form1.submit();
		}else if($("#select").val() == "email"){
			document.form1.action="${path}/freeboard/freeboard_search_email.do";
			document.form1.submit();	
		}
	});
});
...
<c:if test="${page!=null}">
		...
		<form method="post" name="form1">
			...
			<div class="row" align="center" style="width: 100%;">
				<div class="input-group" style="width: 100%;">
					...
					<input type="button" id="freeboardInsert" class="btn btn-primary hidden-xs" value="글쓰기">
					</span>
				</div>
				<!-- /.col-lg-6 -->
	...
	<div align="right">
		<button id="freeboardInsert" class="btn btn-primary visible-xs">글쓰기</button>
	</div>
